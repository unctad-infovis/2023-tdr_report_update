  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        { from: 'assets/data/Figure1 - data.csv', to: '../public/assets/data/2023-tdr_report_update_figure1.csv', noErrorOnMissing: true, globOptions: { dot: true, gitignore: true, ignore: ['**/.DS_Store'] }},
